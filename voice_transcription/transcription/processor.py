...
def process_audio_file(audio_file_path: str, num_speakers: int = None) -> str:
    """
    Processes the audio file and returns a combined transcription.
    """
    results = process_voice_file(audio_file_path, num_speakers=num_speakers)
